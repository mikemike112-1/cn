...
# sys is used for bringing in certain functions from inside the python environment(world)
import sys

# "from" picks a specific group of code that can be used from the pygame
