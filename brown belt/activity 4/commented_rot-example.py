# We start off with all our imports here
import pygame
import random
from os import path

# Now create the variables for the screen
WIDTH = 360
HEIGHT = 480
FPS = 30

# Here we have the variables for the colors
WHITE = (255, 255, 255)
BLACK = (0, 0, 0)
RED = (255, 0, 0)
GREEN = (0, 255, 0)
...
# Here we have the class for the player
class Player(pygame.sprite.Sprite):

    # This function initializes some of the variables and properties for this class
    def __init__(self):
    ...
    # This function updates the status of the rotation that is happening
    def update(self):
